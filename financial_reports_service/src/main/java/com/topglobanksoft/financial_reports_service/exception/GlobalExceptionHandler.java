...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorDetails> handleReportGenerationException(ReportGenerationException ex, WebRequest request) {
    ...
    @ExceptionHandler(ResourceNotFoundException.class) // New, if service client indicates resource not found
    ...
    @ExceptionHandler(IllegalArgumentException.class) // Catches controller-level validation like date order
    ...
    @ExceptionHandler(MethodArgumentNotValidException.class) // For @Valid on DTOs (if ReportRequestDTO was a class)
